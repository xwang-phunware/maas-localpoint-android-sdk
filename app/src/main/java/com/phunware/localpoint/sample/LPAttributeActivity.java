...
public class LPAttributeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.phunware.localpoint.sample.R.layout.activity_lpattribute);
		attributesEditText = (EditText) findViewById(com.phunware.localpoint.sample.R.id.attributes_value);
		final Button updateButton = (Button) findViewById(com.phunware.localpoint.sample.R.id.button_send_attributes);
