	...
	List<ILPMessage> expiredOffers;
	 ...
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(com.phunware.localpoint.sample.R.layout.activity_lpmessage);
	    ...
	    private void processValidOffers() {
	        ...
	        ListView validOffersListView = (ListView) findViewById(com.phunware.localpoint.sample.R.id.validOffersList);
	    ...
	    private void processExpiredOffers() {
	        // Get the list view for the valid offers
	        ListView expiredOffersListView = (ListView) findViewById(com.phunware.localpoint.sample.R.id.expiredOffersList);
	        // Loop the offers to prepare the ArrayAdapter
